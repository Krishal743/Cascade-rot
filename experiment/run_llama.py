"""Experiment runner for Chain A with Llama model."""
...
def run_full_dataset():
    ...
    for i, item in enumerate(dataset):
        ...
        # Add metadata - include semantic validation and cascade
        result = {
            "query": query,
    ...
    final_path = "results/llama_results.json"
